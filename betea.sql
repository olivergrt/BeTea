...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 29 mars 2022 à 12:10
...
CREATE TABLE IF NOT EXISTS `administrateur` (
  ...
  `statut_maintenance` varchar(5) NOT NULL DEFAULT 'off',
...
INSERT INTO `administrateur` (`id_admin`, `nom_admin`, `prenom_admin`, `mail_admin`, `mdp_admin`, `statut_maintenance`) VALUES
(1, 'Admin', 'Administrateur', 'test@test.fr', '58ad983135fe15c5a8e2e15fb5b501aedcf70dc2', 'Off');
...
(1, 'BT-3356781815711115', 'BT38637', 'Problème avec une commande.'),
(2, 'BT-3356781815711115', 'BT38637', 'Il manque 1 cookie dans ma commande.'),
(10, 'BT-3799479426926050', 'BT38637', 'Les points de fidélité n\'ont pas été appliqués.');
...
INSERT INTO `client` (`id_client`, `code_client`, `nom_client`, `prenom_client`, `mail_client`, `mdp_client`, `nbr_point_client`, `chemin_qr_code`) VALUES
(1, '1', 'Enzo', 'Sin', 'enzo.sin@gmail.com', '58ad983135fe15c5a8e2e15fb5b501aedcf70dc2', 280, 'phpqrcode/qr_code/61e37dafde37a.png'),
(2, 'BTPOZBQL', 'Dupont', 'Jean', 'jean.dupont@gmail.com', '58ad983135fe15c5a8e2e15fb5b501aedcf70dc2', 10, 'phpqrcode/qr_code/61e37e46068ac.png'),
(3, 'BTWNBVM', 'Marie', 'Dupont', 'marie.dupont@gmail.com', '58ad983135fe15c5a8e2e15fb5b501aedcf70dc2', 100, 'phpqrcode/qr_code/61e37e8a26670.png'),
(8, 'BT38637', 'Grant', 'Oliver', 'oliver.grant@gmail.com', '58ad983135fe15c5a8e2e15fb5b501aedcf70dc2', 320, 'phpqrcode/qr_code/61e348acafac2.png'),
(11, 'BT487961', 'test', 'test', 'test@ezhuj.eomf', '58ad983135fe15c5a8e2e15fb5b501aedcf70dc2', 10, 'phpqrcode/qr_code62315376005a3.png'),
(12, 'BT446229', 'test', 'test', 'test@test.test', '58ad983135fe15c5a8e2e15fb5b501aedcf70dc2', 10, 'phpqrcode/qr_code62374c55d0749.png'),
(13, 'BT364610', 'test', 'test', 'tets@jzeh.fr', '58ad983135fe15c5a8e2e15fb5b501aedcf70dc2', 10, 'phpqrcode/qr_code623cc1ed4bdbc.png'),
(14, 'BT173899', 'tets', 'test', 'tets@ezuik.fr', '58ad983135fe15c5a8e2e15fb5b501aedcf70dc2', 10, 'phpqrcode/qr_code623cc6cda2555.png'),
(15, 'BT048870', 'test', 'test', 'test@hgej.fre', '58ad983135fe15c5a8e2e15fb5b501aedcf70dc2', 10, 'phpqrcode/qr_code623d8c69e35bd.png');
...
(76, 'BT-7191912411569726', '1', '1 Brownie, ', 2, '2022-02-08 16:08:46', 5, 'Terminé'),
(78, 'BT-1631208334272474', 'BT38637', '1 Jasmine Green Tea, ', 4.5, '2022-02-14 14:49:34', 0, 'Terminé'),
(81, 'BT-3356781815711115', 'BT38637', '1 Cookie, 1 Brookie, 1 Carrot Cake, 1 Banana Bread, ', 9.2, '2022-03-01 16:30:14', 20, 'Terminé'),
(90, 'BT-3991785170713966', 'BT38637', '354 Cookie, 6 Taro Milk Tea , 4 Jasmine Green Tea, ', 1186.8, '2022-03-14 18:31:05', 0, 'En cours'),
...
(96, 'BT-7691779920686430', 'BT38637', '1 Jasmine Green Milk Tea, 1 Black Milk Tea, ', 9.6, '2022-03-22 15:48:43', 20, 'En attente'),
(97, 'BT-4264378775973946', 'BT38637', '1 Jasmine Green Milk Tea, ', 4.8, '2022-03-28 10:37:51', 10, 'Annulée');
...
CREATE TABLE IF NOT EXISTS `ligne_commande` (
  ...
  `code_commande` varchar(50) NOT NULL,
  `id_produit_ligne` int(11) NOT NULL,
...
INSERT INTO `ligne_commande` (`id_ligne`, `code_commande`, `id_produit_ligne`, `quantite_produit`) VALUES
(1, 'BT-7691779920686430', 1, 1),
(2, 'BT-7691779920686430', 11, 1),
(3, 'BT-4264378775973946', 1, 1),
(4, 'BT-3564811478524372', 2, 1),
(5, 'BT-9281346128971291', 4, 1),
(6, 'BT-8454648650334885', 1, 1),
(7, 'BT-8454648650334885', 13, 1),
(8, 'BT-8454648650334885', 17, 1),
(9, 'BT-8454648650334885', 22, 1),
(10, 'BT-8454648650334885', 38, 1),
(11, 'BT-8454648650334885', 45, 1);
